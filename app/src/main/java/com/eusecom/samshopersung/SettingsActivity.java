...
public class SettingsActivity extends android.preference.PreferenceActivity {
    ...
    public static final String MFIR = "mfir";
    public static final String MFIRNAZ = "mfirnaz";
    ...
    public static String getMfir(Context ctx) {
        return PreferenceManager.getDefaultSharedPreferences(ctx).getString(MFIR, "0");
    }

    public static String getMfirnaz(Context ctx) {
        return PreferenceManager.getDefaultSharedPreferences(ctx).getString(MFIRNAZ, "");
    }
