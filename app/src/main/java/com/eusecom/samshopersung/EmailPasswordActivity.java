...
import com.eusecom.samshopersung.models.User;
...
public class EmailPasswordActivity extends BaseListActivity implements
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            onAuthSuccessCreate(task.getResult().getUser());
                        }
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            String emailx = SettingsActivity.getUserName(this);
            String pswx = SettingsActivity.getUserPsw(this);

            mEmailField.setText(emailx);
            mPasswordField.setText(pswx);
