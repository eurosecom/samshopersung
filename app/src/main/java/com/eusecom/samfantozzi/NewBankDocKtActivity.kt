...
class NewBankDocKtActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        NewBankDocKtActivityUI(_rxBus).setContentView(this)
        ...
        mPagerAdapter = object : FragmentPagerAdapter(supportFragmentManager) {
            private val mFragments = arrayOf(NewBankDocFragment(), EmptyKtFragment())
